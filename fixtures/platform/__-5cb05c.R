structure(list(period_id = c("1999Q1", "1999Q2", "1999Q3", "1999Q4", 
...
"2024Q3", "2024Q4", "2025Q1"), value = c(0x0p+0, 0x0p+0, 0x0p+0, 
...
0x0p+0, 0x0p+0, 0x0p+0, 0x0p+0, 0x0p+0, 0x0p+0, 0x0p+0, 0x0p+0, 
0x0p+0, 0x0p+0, 0x0p+0, 0x0p+0, 0x0p+0, 0x0p+0, 0x0p+0, 0x0p+0, 
0x0p+0, 0x0p+0, 0x0p+0, 0x0p+0, 0x0p+0, 0x0p+0)), class = "data.frame", row.names = c(NA, 
-105L))
